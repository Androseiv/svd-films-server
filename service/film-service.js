...
class FilmService {
  ...
  async addFavouriteFilm(film_id, user_id) {
    ...
    return (await db.query(`INSERT INTO favourite_film(id, time, user_id) VALUES ('${film_id}', now(), '${user_id}') RETURNING *`))[0];
  }
  ...
  async addLaterFilm(film_id, user_id) {
    ...
    return (await db.query(`INSERT INTO later_film(id, time, user_id) VALUES ('${film_id}', now(),  '${user_id}') RETURNING *`))[0];
  }
  ...
  async addRatedFilm(film_id, rating, user_id) {
    ...
    return (await db.query(`INSERT INTO rated_film(id, time, user_id, rating) VALUES ('${film_id}', now(), '${user_id}', '${rating}') RETURNING *`))[0];
  }
