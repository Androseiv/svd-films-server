...
router.get('/:user_id/films/favourite/', FilmController.getFavouriteFilms);
...
router.get('/:user_id/films/later', FilmController.getLaterFilms);
...
router.get('/:user_id/films/rated', FilmController.getRatedFilms);
...
router.get('/info/film/:film_id/:user_id', authMiddleware, FilmController.userFilm);
